 ...
 * View dealer details, listings, and reviews
 */
  ...
  const fetchDealerData = async () => {
    try {
      ...
      if (dealerResponse.ok) {
        ...
        setStatistics(dealerData.statistics)
      }
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-2">
                ...
                {dealer.is_verified && (
                  <div className="bg-green-500 p-2 rounded-full" title="Verified Dealer">
                    <Shield size={20} />
                  </div>
                )}
              </div>
              ...
              <div className="flex flex-wrap gap-6 text-sm">
                ...
                {statistics?.totalReviews > 0 && (
                  <div>
                    ...
                    <span className="font-semibold ml-2">
                      {statistics.averageRating} ★ ({statistics.totalReviews} reviews)
                    </span>
                  </div>
                )}
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <p className="text-3xl font-bold text-gray-900">
                {Math.round((statistics.totalReviews / (statistics.totalReviews + 1)) * 100) || 0}%
              </p>
